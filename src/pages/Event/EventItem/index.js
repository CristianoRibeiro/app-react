    ...
    const screen = [
      {
        ...
        name: 'INFORMAÇÕES',
        item: item,
        permission: app_functions ? app_functions.info : false,
        //permission: true,
        type: null,
      },
      {
        ...
        item: item,
        permission: app_functions ? app_functions.useful_info : false,
        //permission: true,
        type: null,
      },
      {
        ...
        name: 'PROGRAMAÇÃO',
        item: item,
        permission: app_functions ? app_functions.schedule : false,
        //permission: true,
        type: 'schedule',
      },
      {
